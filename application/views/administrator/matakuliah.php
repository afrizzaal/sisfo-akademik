    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        foreach ($matakuliah as $mk) : ?>
            <tr>
                ...
                <td width="20px"><?php echo anchor('administrator/matakuliah/detail/' . $mk->kode_matakuliah, ' <div class="btn btn-sm btn-info"><i class="fa fa-eye"></i></div>') ?>
                </td>
