    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        foreach ($tahun_akademik as $ak) : ?>
            <tr>
                ...
                <td width="20px"><?php echo anchor('administrator/tahun_akademik/update/' . $ak->id_tahunakademik, ' <div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div>') ?>
                </td>
                <td width="20px"><?php echo anchor('administrator/tahun_akademik/delete/' . $ak->id_tahunakademik, ' <div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
